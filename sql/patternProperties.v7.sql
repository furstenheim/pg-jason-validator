...
SELECT pattern_properties_v7_1('{"foo":1}');
-- object with property matching schema false is invalid
SELECT pattern_properties_v7_1('{"bar":2}');
-- object with both properties is invalid
SELECT pattern_properties_v7_1('{"foo":1,"bar":2}');
-- object with a property matching both true and false is invalid
SELECT pattern_properties_v7_1('{"foobar":1}');
-- empty object is valid
SELECT pattern_properties_v7_1('{}');
